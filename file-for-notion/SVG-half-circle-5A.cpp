...
//
// 創建SVG文件
std::ofstream svgFile("file-5A.svg");
//
...
int main() {
    ...
    /*
    // method 1
    posi_xy = make_tuple(50, 300);
    text_x = to_string(get<0>(posi_xy));
    text_y = to_string(get<1>(posi_xy));
    */
    // method 2
    text_x = "50";
    text_y = "300";
    text = "SVG-half-circle-5A";
    draw_text(text_x, text_y, "Verdana", "50", "black",text);
    //
    // 寫入SVG尾部
