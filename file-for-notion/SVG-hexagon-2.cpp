...
int main() {
    ...
    draw_polygon(border_xy, "lightsteelblue", "sandybrown", 5);
    //
    // 添加 grid h line
    int x0, x1, y0, y1;
    x0 = 0;
    ...
    dy = -100.0*sqrt(3.0)/2;
    cout << dy << endl;
    translate_polygon(make_tuple(0, 1*dy), 
                      hexagon_xy, "none", "green", 1);
    translate_polygon(make_tuple(0,-1*dy), 
                      hexagon_xy, "none", "green", 1);
    translate_polygon(make_tuple(0, 2*dy), 
                      hexagon_xy, "none", "green", 1);
    translate_polygon(make_tuple(0,-2*dy), 
                      hexagon_xy, "none", "green", 1);
    translate_polygon(make_tuple(0, 3*dy), 
                      hexagon_xy, "none", "green", 1);
    translate_polygon(make_tuple(0,-3*dy), 
                      hexagon_xy, "none", "green", 1);
    //
