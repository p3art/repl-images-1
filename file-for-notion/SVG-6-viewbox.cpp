...
//
// 創建SVG文件
std::ofstream svgFile("SVG-6-viewbox.svg");
//
...
int main() {
    ...
    // file-4.svg
    svgFile << "<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"800px\" height=\"600px\" viewBox=\"0 0 1200 900\">" << std::endl;
    //
    // 添加 border polyline
    border_xy = "0,0 800,0 800,600 0,600 0,0";
    //draw_polygon(border_xy, "black", "lightblue", 4);
    draw_polyline(border_xy, "black", "lightblue", 4);
    //
    // 添加 grid h line
    int i_max = 13;
    int x0, x1, y0, y1;
    ...
    draw_polyline(line_1_xy, "none", "blue", 4);
    draw_polyline(line_2_xy, "none", "blue", 4);
    ...
    cout << circle_xy << endl;
    draw_polyline(circle_xy, "none", "red", 3);
    //
    // 寫入SVG尾部
